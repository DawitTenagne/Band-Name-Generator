...
function randomNmae() {
  ...
  const n = Math.random();
  const nounIndex = Math.floor(n * nounLength);
  const adjIndex = Math.floor(n * adjLength);
  const randomBandName = adj[adjIndex] + "  " + noun[nounIndex];
...
app.post("/submit", (req, res) => {
  res.render("index.ejs", { bandName: randomNmae() });
